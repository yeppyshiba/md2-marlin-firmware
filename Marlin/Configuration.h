...
#define STRING_CONFIG_H_AUTHOR "yeppyshiba" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EJLOVE"
...
#define INVERT_X_DIR true //lv8729   Motor direction is true (MKSboard)
#define INVERT_Y_DIR true //lv8729   Motor direction is true (MKSboard)
#define INVERT_Z_DIR false // 4988 mks 430mm false

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true //mks 4988 right true
#define INVERT_E1_DIR true //mks 4988 right true
